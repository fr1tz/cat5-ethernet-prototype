...
datablock PlayerData(PlayerPod)
{
	...
	maxSideSpeed = 100;
	maxForwardSpeedSliding = 100;
	maxBackwardSpeedSliding = 100;
	maxSideSpeedSliding = 100;
...
function PlayerPod::onAdd(%this, %obj)
{
	ShapeBaseData::onAdd(%this, %obj);
	%obj.setBodyPose($PlayerBodyPose::Sliding);
}

function PlayerPod::onTrigger(%this, %obj, %triggerNum, %val)
{

}

function PlayerPod::damage(%this, %obj, %sourceObject, %pos, %damage, %damageType)
{
	return;
...
function PlayerPod::impulse(%this, %obj, %position, %impulseVec, %src)
{
	// ignore impulses
}
