...
datablock TSShapeConstructor(StandardCatDts)
{
...
datablock PlayerData(StandardCat)
{
	className = Cat;
...
{
	StandardCat.groundConnectionBeam = "";
}

if($Server::Game.noshield)
	StandardCat.damageBuffer = 0;

if($Server::Game.lowhealth)
	StandardCat.maxDamage = 50;
