...
datablock TSShapeConstructor(SpecialistDts)
{
	baseShape = "share/shapes/cat5/specialist.dts";
...
datablock PlayerData(FrmSpecialist)
{
   allowColorization = true;
	...
	shapeFile = "share/shapes/cat5/specialist.dts";
...
if($Server::Game.lowhealth)
	FrmSpecialist.maxDamage = 50;

function FrmSpecialist::onAdd(%this, %obj)
{
