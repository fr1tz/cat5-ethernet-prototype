...
datablock TSShapeConstructor(MinigunnerDts)
{
	baseShape = "share/shapes/cat5/minigunner.dts";
...
datablock PlayerData(FrmMinigunner)
{
   allowColorization = true;
	...
	shapeFile = "share/shapes/cat5/minigunner.dts";
	...
	maxForwardSpeedCrouched = 2 * $Server::Game.slowpokemod;
	maxBackwardSpeedCrouched = 2 * $Server::Game.slowpokemod;
	maxSideSpeedCrouched = 2 * $Server::Game.slowpokemod;
...
if($Server::Game.lowhealth)
	FrmMinigunner.maxDamage = 50;

function FrmMinigunner::onAdd(%this, %obj)
{
