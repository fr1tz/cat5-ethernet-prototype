...
datablock TSShapeConstructor(GruntDts)
{
...
if($Server::Game.lowhealth)
	FrmGrunt.maxDamage = 50;

function FrmGrunt::onAdd(%this, %obj)
{
	Parent::onAdd(%this, %obj);
	%obj.mountImage(StandardCatLightImage, 3);
   %obj.mountImage(AssaultRifleImage, 0, -1, true);
}
