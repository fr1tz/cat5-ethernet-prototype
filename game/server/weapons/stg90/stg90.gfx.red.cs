...
datablock LaserBeamData(RedSTG90ProjectileLaserTail)
{
	hasLine = true;
	lineStartColor	= "1.00 0.00 0.00 0.0";
	lineBetweenColor = "1.00 0.00 0.00 1.0";
	lineEndColor	  = "1.00 0.00 0.00 0.0";
 	lineWidth		  = 2.0;
	...
	bitmap = "share/textures/inf/lasertail1.red";
	bitmapWidth = 2.0;
...
datablock ParticleData(RedSTG90ProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(RedSTG90ProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "RedSTG90ProjectileImpact_Smoke";
};

datablock DebrisData(RedSTG90ProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(RedSTG90ProjectileImpact)
{
	...
	emitter[1] = RedSTG90ProjectileImpact_SmokeEmitter;

	//debris = RedSTG90ProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ExplosionData(RedSTG90ProjectileHit)
{
