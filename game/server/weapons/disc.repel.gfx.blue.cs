...
datablock MultiNodeLaserBeamData(BlueRepelDiscInnerLaserTrail)
{
	hasLine = false;
...
datablock MultiNodeLaserBeamData(BlueRepelDiscOuterLaserTrail)
{
	hasLine = false;
	lineColor	= "1.00 0.00 0.00 0.3";
...
datablock ParticleData(BlueRepelDiscExplosion_Emitter_Particle)
{
	dragCoefficient		= 0.0;
...
datablock ParticleEmitterData(BlueRepelDiscExplosion_Emitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 0;
	...
	lifetimeMS		 = 100;
	particles = BlueRepelDiscExplosion_Emitter_Particle;
};

datablock ExplosionData(BlueRepelDiscExplosion)
{
	...
	emitter[0] = BlueRepelDiscExplosion_Emitter;
...
datablock ExplosionData(BlueRepelDiscDeflectedEffect)
{
...
datablock ExplosionData(BlueRepelDiscBounceEffect)
{
...
datablock DebrisData(BlueRepelDiscHit_Debris)
{
	// shape...
...
datablock ExplosionData(BlueRepelDiscHit)
{
	...
	//debris = BlueRepelDiscHit_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 3;
	//debrisNumVariance = 1;
...
datablock ExplosionData(BlueRepelDiscHitEnemy)
{
	soundProfile = DiscHitSound;
