...
datablock MultiNodeLaserBeamData(BlueSniperProjectileLaserTrailOne)
{
	hasLine   = true;
	...
	bitmap = "share/textures/rotc/lasertail1.blue";
	bitmapWidth = 3.0;
...
datablock MultiNodeLaserBeamData(BlueSniperProjectileLaserTrailTwo)
{
	hasLine   = false;
