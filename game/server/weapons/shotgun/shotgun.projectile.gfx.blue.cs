...
datablock LaserBeamData(BlueShotgunProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(BlueShotgunProjectileLaserTrail)
{
	hasLine = true;
	lineColor	= "0.00 0.00 1.00 1.0";

	hasInner = true;
	innerColor = "0.00 1.00 1.00 1.0";
	innerWidth = "0.10";
...
datablock ParticleData(BlueShotgunProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(BlueShotgunProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueShotgunProjectileImpact_Smoke";
};

datablock DebrisData(BlueShotgunProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(BlueShotgunProjectileImpact)
{
	...
	emitter[1] = BlueShotgunProjectileImpact_SmokeEmitter;

	//debris = BlueShotgunProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(BlueShotgunProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
...
datablock ParticleEmitterData(BlueShotgunProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueShotgunProjectileHit_Particle";
};

datablock ExplosionData(BlueShotgunProjectileHit)
{
	soundProfile = ShotgunProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = BlueShotgunProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(BlueShotgunProjectileMissedEnemyEffect)
{
