...
datablock ParticleData(BlueRepelGunProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(BlueRepelGunProjectileParticleEmitter)
{
	ejectionPeriodMS = 40;
	periodVarianceMS = 10;
	...
	lifetimeMS		 = 0;
	particles = "BlueRepelGunProjectileParticleEmitter_Particles";
};

//-----------------------------------------------------------------------------
// laser trail

datablock MultiNodeLaserBeamData(BlueRepelGunProjectileLaserTrail)
{
	hasLine = false;
...
datablock MultiNodeLaserBeamData(BlueRepelGunProjectileLaserTrail2)
{
	hasLine = true;
...
datablock LaserBeamData(BlueRepelGunProjectileLaserTail)
{
	hasLine = true;
...
datablock ExplosionData(BlueRepelGunProjectileBounceExplosion)
{
...
datablock ExplosionData(BlueRepelGunProjectileExplosion)
{
	soundProfile = RepelGunProjectileDebrisSound;
	
	emitter[0] = DefaultMediumWhiteDebrisEmitter;	

	//debris = BlueRepelGunProjectileExplosion_SmallDebris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 5;
	//debrisVelocity = 15.0;
...
datablock ParticleData(BlueRepelGunProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(BlueRepelGunProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "BlueRepelGunProjectileImpact_Smoke";
};

datablock DebrisData(BlueRepelGunProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(BlueRepelGunProjectileImpact)
{
	soundProfile	= BlueRepelGunProjectileImpactSound;
	...
	emitter[0] = BlueRepelGunProjectileImpact_SmokeEmitter;

	debris = BlueRepelGunProjectileImpact_Debris;
	debrisThetaMin = 0;
	debrisThetaMax = 60;
	debrisNum = 2;
	debrisNumVariance = 1;
