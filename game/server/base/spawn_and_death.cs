...
function pickSpawnSphere(%teamId)
{
	 ...
	 {
		 if( %teamId == 1 ) %groupName = "MissionEnvironment/RedSpawnPoints";
		 if( %teamId == 2 ) %groupName = "MissionEnvironment/BlueSpawnPoints";
	 }
...
{
	%groupName = "MissionEnvironment/ObserverPoints";
	%group = nameToID(%groupName);
