...
function EditorGui::addWindow(%control)
{
	EditorGui.add(%control);
	%control.onAddedAsWindow();
	Canvas.repaint();
}

function EditorGui::removeWindow(%control)
{
...
function EditorGui::init(%this)
{
	...
	EditorMenuBar.addMenu("Mode", 2);
	EditorMenuBar.addMenuItem("Mode", "World Editor", 2, "F2", 1);
	EditorMenuBar.addMenuItem("Mode", "World Editor Inspector", 3, "F3", 1);
	EditorMenuBar.addMenuItem("Mode", "World Editor Creator", 4, "F4", 1);
	EditorMenuBar.addMenuItem("Mode", "Mission Area Editor", 5, "F5", 1);
	EditorMenuBar.addMenuItem("Mode", "-", 0);
	EditorMenuBar.addMenuItem("Mode", "Terrain Editor", 6, "F6", 1);
	EditorMenuBar.addMenuItem("Mode", "Terrain Terraform Editor", 7, "F7", 1);
	EditorMenuBar.addMenuItem("Mode", "Terrain Texture Editor", 8, "F8", 1);
	EditorMenuBar.addMenuItem("Mode", "Terrain Texture Painter", 9, "", 1);

	EditorMenuBar.addMenu("Lighting", 8);
	EditorMenuBar.addMenuItem("Lighting", "Full Relight", 1, "Alt L");
	EditorMenuBar.addMenuItem("Lighting", "Filtered Relight", 2, "Alt F");
	EditorMenuBar.addMenuItem("Lighting", "-", 0);
	EditorMenuBar.addMenuItem("Lighting", "Production", 3, "", 1);
	EditorMenuBar.addMenuItem("Lighting", "Design", 4, "", 1);
	EditorMenuBar.addMenuItem("Lighting", "Draft", 5, "", 1);
	EditorMenuBar.addMenuItem("Lighting", "-", 0);
    EditorMenuBar.addMenuItem("Lighting", "Shadows", 6, "", 2);
	EditorMenuBar.addMenuItem("Lighting", "-", 0);
	EditorMenuBar.addMenuItem("Lighting", "Reset All Light Animation", 7);
 
	EditorMenuBar.addMenu("Interior", 9);
	EditorMenuBar.addMenuItem("Interior", "Render normal", 0, "", 1);
 	EditorMenuBar.addMenuItem("Interior", "Render wireframe", 1, "", 1);
 	EditorMenuBar.addMenuItem("Interior", "Show details", 2, "", 1);
   	EditorMenuBar.addMenuItem("Interior", "Show ambiguous", 3, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show orphans", 4, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show lightmaps", 5, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show textures only", 6, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show portal zones", 7, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show outside visible", 8, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show collision fans", 9, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show strips", 10, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show NULL surfaces", 11, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show large textures", 12, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show hull surfaces", 13, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show vehicle hull surfaces", 14, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show vertex colors", 15, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show detail level", 16, "", 1);
    EditorMenuBar.addMenuItem("Interior", "Show vertex normals", 17, "", 1);
    ...
    EditorMenuBar.setMenuItemChecked("Lighting", 3 + $pref::LightManager::sgLightingProfileQuality, true);
    EditorMenuBar.setMenuItemChecked("Lighting", 6, $pref::LightManager::sgLightingProfileAllowShadows);
...
function EditorMenuBar::onMenuItemSelect(%this, %menuId, %menu, %itemId, %item)
{
	switch$(%menu)
	{
		...
		case "Mode":
			%this.onModeMenuItemSelect(%itemId, %item);
		case "Action":
		...
		case "Lighting":
			%this.onLightingMenuItemSelect(%itemId, %item);
		case "Interior":
			%this.onInteriorMenuItemSelect(%itemId, %item);
		case "Windows":
			%this.onWindowsMenuItemSelect(%itemId, %item);
	}
}
...
function EditorMenuBar::onLightingMenuItemSelect(%this, %itemId, %item)
{
	switch$(%item)
	{
		case "Filtered Relight":
		...
		case "Production":
            ...
            EditorMenuBar.setMenuItemChecked("Lighting", %item, true);
		...
		case "Shadows":
            %value = !$pref::LightManager::sgLightingProfileAllowShadows;
            $pref::LightManager::sgLightingProfileAllowShadows = %value;
            EditorMenuBar.setMenuItemChecked("Lighting", %item, %value);
            
		case "Reset All Light Animation":
...
function EditorMenuBar::onModeMenuItemSelect(%this, %itemId, %item)
{
	EditorGui.setEditor(%item);
}

function EditorMenuBar::onInteriorMenuItemSelect(%this, %itemId, %item)
{
    if(!setInteriorRenderMode(%itemId))
        MessageBoxOK("Denied", "This is not allowed in multiplayer mode.");
}

function EditorMenuBar::onWindowsMenuItemSelect(%this, %itemId, %item)
{
	switch$(%item)
	{
		case "Light Editor":
		...
		case "Terrain Editor Settings":
            EditorGui::addWindow(TerrainEditorSettings);
		case "Terrain Editor Soft Selection":
            EditorGui::addWindow(TerrainEditorSoftSelection);
...
{
	EditorMenuBar.setMenuItemBitmap("Mode", %this.currentEditor, -1);
	EditorMenuBar.setMenuItemBitmap("Mode", %editor, 0);
